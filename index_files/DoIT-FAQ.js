...
$("[id=accordion] *").removeAttr("style");
     var icons = {
      header: "ui-icon-circle-arrow-e",
      activeHeader: "ui-icon-circle-arrow-s"
    };
    $(("[id=accordion]")).accordion({
      icons: icons,  active : 'none', heightStyle: "content",  collapsible: true 
          });
...
(function($) {
  ...
  /*       var $accordionSecion = $(window.location.hash);
         ...
         */
            ...
            $this.addClass("ui-accordion ui-widget ui-widget-content")
            ...
            .next(opts.container)
            .addClass("ui-accordion-content ui-helper-reset", function() {
                if (isOpen($this)) {
